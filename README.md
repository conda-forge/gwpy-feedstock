...
Development: https://gitlab.com/gwpy/gwpy.git

Documentation: https://gwpy.github.io/docs/4.0.2/
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/gwpy-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/gwpy-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
It is possible to list all of the versions of `gwpy` available on your platform:
...
```
pixi search gwpy --channel conda-forge
```
